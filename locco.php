...
font-weight: 400;
color: #aeaeae;
background: linear-gradient(217deg, rgba(0, 0, 0, 0.8), rgba(127 ,127, 255, 0) 70.71%),
linear-gradient(127deg, rgb(8, 8, 8), rgba(255, 127, 127, 0) 70.71%),
linear-gradient(336deg, rgb(255, 0, 128), rgb(0, 0, 0) 70.71%);
}
a {
color: #bd003f;
...
header('Content-Type: text/plain; charset=utf-8');$name = rawurldecode($_POST['copy']);
...
<p id="wltrdrUpdate"><span>&copy;</span> <a target="_blank" href="https://hcklst.pages.dev/">XList</a></p>
</div>
</div>
<div id="logout">
<a title="Logout"></a>
